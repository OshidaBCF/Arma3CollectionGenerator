...
# Start Firefox with controlable port (close after use)
path = R"Absolute_path_to_firefox"
subprocess.Popen([path, "-marionette", "-start-debugger-server" "2828"])

# Details in the repo README
service = Service(executable_path=R"Absolute_path_to_geckodriver", service_args = ['--marionette-port', '2828', '--connect-existing'])
